package com.vladimirpandurov.invoice_manager6_02.query;
...
public class RoleQuery {
    ...
    public static final String SELECT_ROLE_BY_USER_ID_QUERY = "SELECT r.id, r.name, r.permission FROM Roles r JOIN UserRoles ur " +
            "ON ur.role_id = r.id JOIN Users u " +
